...
#TODO: replace with path to h5 files. p should be 2D cases with control rods out and f with rods in, both with normal mesh
for i in range(1, 4):
    p = h5py.File("/scratch/wrm_fluxoe/ehcole/IPEN_Analysis/version4/boron/IPEN-020m/4-2-" + str(i) + ".h5", 'r')
    f = h5py.File("/scratch/wrm_fluxoe/ehcole/IPEN_Analysis/version4/boron/IPEN-019m/4-2-" + str(i) + ".h5", 'r')
