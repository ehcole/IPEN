...
for i in range(1, 7):
    if i <= 3:
        ...
        lastState = 5
    h5 = h5py.File(pathToTopLevel + "/experiments/4.1/outputs/4-1_critical/4-1-" + str(i) + ".h5", 'r')
    h5p = h5py.File(pathToTopLevel + "/experiments/4.1/outputs/4-1_critical/4-1-/" + str(i) + ".h5", 'r')
