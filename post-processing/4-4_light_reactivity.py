...
pathToTopLevel = '.'
f = h5py.File(pathToTopLevel + "/experiments/4.4/outputs/3D/4-4_light_critical.h5", 'r')
p = h5py.File(pathToTopLevel + "/experiments/4.4/outputs/3D/4-4_light_perturbed.h5", 'r')
