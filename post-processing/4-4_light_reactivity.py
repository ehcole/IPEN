...
#TODO: replace with path to .h5 files. f should be critical case, p should be perturbed case
f = h5py.File("/scratch/wrm_fluxoe/ehcole/IPEN_Analysis/version3/IPEN-018/4-4_light_critical.h5", 'r')
p = h5py.File("/scratch/wrm_fluxoe/ehcole/IPEN_Analysis/version3/IPEN-018/4-4_light_perturbed.h5", 'r')
