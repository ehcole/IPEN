...
f = h5py.File("/scratch/wrm_fluxoe/ehcole/IPEN_Analysis/version3/IPEN-017/4-4_heavy_critical.h5", 'r')
p = h5py.File("/scratch/wrm_fluxoe/ehcole/IPEN_Analysis/version3/IPEN-017/4-4_heavy_perturbed.h5", 'r')
